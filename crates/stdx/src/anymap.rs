//! This file is a port of only the necessary features from <https://github.com/chris-morgan/anymap> version 1.0.0-beta.2 for use within sail-lsp.
//!
...
/// that my `insert_and_get_on_260_types` benchmark is ~12us instead of ~21.5us), but will
